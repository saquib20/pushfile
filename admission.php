	...
	<div class="container-fluid">
			...
			<div class="col-md-12">
				<form action="student.php" method="POST" enctype="multipart/form-data">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<select class="browser-default custom-select" name="course_code">
									...
									<option value="B.Fashion">B.Fashion</option>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<select class="browser-default custom-select" name="session">
									...
									<option value="S19">S22</option>
									<option value="S19">S23</option>
								</select>
					...
					<div class="modal-footer">
						<input type="submit" class="btn btn-primary" name="btn_save"> <br>
					</div>
				</form>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12 w-100 p-5">
				...
				<p class="tet-justify">
					I solemnly declare that I have submitted the application with the consent of my father / guardian. I pledge to abide by the Rules and Regulations of the ASSI and shall not take part in political activities of any kind. If I do so the ASSI Administration will have the right to strike my name off the ASSI Rolls. I pledge that I will not keep in my possession weapons of any kind whether licensed or unlicensed. I affirm that I was never expelled / rusticated by any Institution at any time. I understand that if my class attendance percentage is not up to the required standard of the ASSI, I will not be eligible to sit in the final examinations. I affirm that if at any stage the documents submitted by me for admission are proved forged, fake, or erroneous I shall be responsible for that and the ASSI Administration shall be rightful to cancel my admission and to take necessary action against me.
				</p>
			</div>
		</div>	
	</div>
